...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_capThread_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_capThread_t qt_meta_stringdata_capThread = {
    {
QT_MOC_LITERAL(0, 0, 9), // "capThread"
QT_MOC_LITERAL(1, 10, 9), // "getPacket"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 6) // "getMAC"

    },
    "capThread\0getPacket\0\0getMAC"
};
...
void capThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->getPacket((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        {
            typedef void (capThread::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&capThread::getPacket)) {
                *result = 0;
            }
        }
        {
            typedef void (capThread::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&capThread::getMAC)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject capThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_capThread.data,
      qt_meta_data_capThread,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *capThread::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_capThread.stringdata))
...
// SIGNAL 0
void capThread::getPacket(QString _t1)
{
...
// SIGNAL 1
void capThread::getMAC(QString _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
